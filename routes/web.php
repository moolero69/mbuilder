...
use App\Http\Controllers\Montaje\MonatajeDiscoDuroController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('montaje/discoDuro', [MonatajeDiscoDuroController::class, 'index'])->name('montaje.discoDuro');

                ...
                <div className="relative min-h-dvh w-full text-white">
                    ...
                    <section className="relative z-20 flex min-h-dvh flex-col items-center justify-center px-6 text-center">
                        <div className="grid w-full grid-cols-1 md:grid-cols-2">
                            {/* CONFIGURADOR */}
                            <div className="flex flex-col items-center justify-center border-b border-[var(--azul-neon)] px-6 py-10 text-center md:border-r md:border-b-0">
                            ...
                            <div className="flex flex-col items-center justify-center px-6 py-10 text-center">
                                ...
                                <p className="max-w-2xl text-white">
                                    Analiza si tu procesador limita a tu tarjeta gráfica o si tu gráfica va sobrada respecto al procesador. Asegúrate
                                    de tener el mejor equilibrio entre potencia y rendimiento.
                                </p>
                        ...
                        <section className="grid grid-cols-1 gap-6 px-6 py-12 text-center md:grid-cols-3">
                            <div className="rounded-lg border border-[var(--verde-neon)] p-6 shadow-lg">
                                <h3 className="text-xl font-semibold text-[var(--verde-neon)]">Compatibilidad</h3>
                ...
                {auth.user && auth.user?.es_pro === 'Si' && (
                    <div className="fixed right-6 bottom-6 z-50">
                        <Dialog onOpenChange={setDialogoAsistencia}>
                            ...
                            <DialogContent className="colores-borde-glow z-60 max-w-xl border-1 bg-neutral-900 text-white">
                                <DialogHeader>
